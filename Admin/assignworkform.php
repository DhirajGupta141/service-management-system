...
?>
 ...
 <div class="col-sm-5 mt-5 jumbotron"><!--Start assigned work 3rd column-->
    <form action="" method="POST">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="requesteremail">Assign to Technician</label>
                <input type="text"class="form-control" id="assigntech" 
                name="assigntech">
            </div>
            <div class="form-group col-md-6">
                <label for="requesteremail">Date</label>
